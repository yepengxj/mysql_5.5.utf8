...
INSERT INTO DH_DATAITEM VALUES ('10', '1002', '1011', '全国在网（新增）终端', 'terminal.png', '手机,iphone', '2', '1', '1', '1.000', '2015-08-01', '2', '2015-07-31', 'EXCEL文件', 'terminal.del', '888888', '全国终端在网和新增终端的分布情况。分省份、地市，统计终端的品牌分布、网龄分布、DOU分布、ARPU分布，平均DOU、平均ARUP等。');
INSERT INTO DH_DATAITEM VALUES ('10', '1002', '1012', '全国终端换机分析', 'terminal.png', '手机,iphone', '2', '1', '1', '1.000', '2015-08-01', '2', '2015-07-31', 'EXCEL文件', 'terminal.del', '888888', '统计全国终端换机分布情况。分省份、地市，统计终端换机前、后的终端品牌、型号，消费ARPU、DOU，换机周期、换机终端数量等。');
INSERT INTO DH_DATAITEM VALUES ('20', '1004', '2000', '银联数据', 'unionpay.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '888855', '通过数十个维度的特征指标，对用户群体进行消费特征分析。包含42亿张银联卡，8亿银联持卡人，1200万家境内联网商户、3000万家境外联网商户、6000万笔日均交易流水。');
INSERT INTO DH_DATAITEM VALUES ('20', '1004', '2001', '工商数据', 'industry_commerce.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '888866', '全国企业、事业、机关、社会团体、民办非企业及其他合法组织的工商数据。共覆盖1800万家单位，覆盖所有省、市、县、乡镇，每日动态更新数据。为校验用户身份提供有效依据。');
INSERT INTO DH_DATAITEM VALUES ('20', '1004', '2002', '社交数据', 'social.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '互联用户的社交数据。包括论坛、贴吧、微博、微信公众号等主流社交网络的用户信息、用户评论、转发，用户关系等数据。可作为品牌效果评价，也可以作为产品改进或者营销创意的依据。');
