...
INSERT INTO DH_DATAITEM VALUES ('10', '1002', '1010', '终端信息', '/img/terminal.png','手机,iphone', '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'EXCEL文件', 'terminal.del', '888888', '市场存量、新增、流转终端品牌、机型、数量等情况。终端ARUP、DOU、网龄、换机、迁徙、离网情况，APP安装情况。');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2000', '银联数据','/img/unionpay.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '888855', '通过数十个维度的特征指标，对用户群体进行消费特征分析，帮助商户勾勒出详细的用户群特征。');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2001', '工商数据', '/img/industry_commerce.png',NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '888866', '1800万家企业数据；覆盖企业、事业、机关、社会团体、民办非企业及其他合法组织；覆盖所有县市乡镇；全国联网操作，数据动态每日汇总，次日更新上线；通过动态数据实时校验用户身份的合法性；实时数据服务接口');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2002', '社交数据','/img/social.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '互联网上公开数据（论坛，贴吧，微博，微信公众号等），用户评论、转发，可作为品牌效果评价，也可以作为产品改进或者营销创意的依据。');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2003', '公交数据','/img/bus.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '首末班发车，发车间隔、甩站、滞站、行车速度、轨迹监管、正点发车、区间校时、单边准点以及考勤、超速、偏航。');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2004', '气象数据','/img/weaher.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '风力风向、每日平均温度、每日最高最低温度、降水量、相对湿度、气压、雷电自建国以来全国2000+国家级地面观测站（人工职守站）的风温湿压雨（风力风向、每日平均温度、每日最高最低温度、降水量、相对湿度）等各气象要素记录；以及5W+区域自动站（无人职守站，2009年接入）的实时监测数据。');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2005', 'GIS地图','/img/GIS_map.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '全国基础地图数据（1:500/1:1000/1:2000/1:5000/1:10000/1:50000）、三维模型数据、360全景数据、遥感影像数据、标准地址数据。');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2006', '农业数据','/img/farming.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111','包括宏观经济景气数据、农村统计数据、农业统计数据、渔业统计数据、畜牧业统计数据、林业统计数据、粮食专题数据、农产品贸易统计数据、饲料专题数据、奶业专题数据、棉花专题数据，蔬菜、水果、茶叶、中药材、水产品价格监测。');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2007', '线上电商零售数据','/img/sell.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '包括京东、天猫、亚马逊、1号店、当当网、我买网、国美、苏宁、聚美网、乐峰网、易迅等线上电商数据。');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2008', '线上医药数据','/img/medicine.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '包括壹药网、康爱、老百姓大药房、好药师、金象网等');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2009', '影视数据','/img/film.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '包括优酷、爱奇艺、搜狐视频、腾讯视频、乐视网、豆瓣、1905等');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2010', '旅游信息','/img/trip.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '包括携程、去哪儿、途牛等数据。');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2011', '交通数据','/img/traffic.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '全国31个省级重点营运车辆200万辆');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2012', 'APP数据','/img/APP.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '全国安卓系统内App应用的留存用户、新增用户、在线用户、推送数据、用户点击行为等核心数据');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2013', '新浪微博数据','/img/sina_weibo.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '新浪微博账号统计数据，7×24h全天候实时监测，账号分析、互动分析、粉丝分析3方面共计11个专业数据维度；腾讯微博账号统计数据；粉丝属性及行为分析；微博传播数据分析；账号互动分析；行业标杆数据对比分析。');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2014', '车辆违章查询、生活服务、定位服务、金融征信','/img/car_peccancy.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '全国车辆违章查询。');
INSERT INTO DH_DATAITEM VALUES ('20', '2002', '2015', '人脸识别','/img/face_identify.png', NULL, '2', '1', '1', '1.000', '2015-08-01', '1', '2015-07-31', 'RAR压缩包', NULL, '111111', '人脸识别身份信息。');
